...
# python -m src scrape "@prabowo (#capres2024 OR #pemilu2024 OR #pilpres2024 OR capres OR presiden)" --since "2021-11-01" --until "2022-12-01" --denied-users "data\denied-users.json" --export "@prabowo (#capres2024 OR #pemilu2024 OR #pilpres2024 OR capres OR presiden) 1Nov21 30Nov22"
# python -m src scrape "@ganjarpranowo (#capres2024 OR #pemilu2024 OR #pilpres2024 OR capres OR presiden)" --since "2021-11-01" --until "2022-12-01" --denied-users "data\denied-users.json" --export "@ganjarpranowo (#capres2024 OR #pemilu2024 OR #pilpres2024 OR capres OR presiden) 1Nov21 30Nov22"
# python -m src scrape "@aniesbaswedan (#capres2024 OR #pemilu2024 OR #pilpres2024 OR capres OR presiden)" --since "2021-11-01" --until "2022-12-01" --denied-users "data\denied-users.json" --export "@aniesbaswedan (#capres2024 OR #pemilu2024 OR #pilpres2024 OR capres OR presiden) 1Nov21 30Nov22"
# python -m src scrape "@prabowo \"calon presiden\"" --since "2021-01-01" --until "2022-12-01" --export "@prabowo calon presiden 1Jan21 30Nov22" 
# python -m src scrape "@prabowo (#capres2024 OR #pemilu2024 OR #pilpres2024 OR capres OR presiden OR \"calon presiden\")" --since "2021-01-01" --until "2022-12-01" --export "@prabowo (#capres2024 OR #pemilu2024 OR #pilpres2024 OR capres OR presiden OR calon presiden) 1Jan21 30Nov22"
# python -m src scrape "capres" --since "2022-11-01" --until "2022-12-01" --export "capres Nov 2022" 